...
numVentanas = 13
ventanasPasadas = int(0)

direccionGiro = [[0, 0], [0, 0], [0, 0], [0.45, 0.75], [0.3, 0.85], [0.35, 1.6], [0.3, 0.95], [0, 0], [0, 0], [0, 0], [0.45, 0.75], [0.45, 0.75]]
...
if __name__ == "__main__":
    ...
    controller.takeoff()
    rospy.sleep(2)
    controller.lanzame(linear_z=0.7, tiempo=1.3)
    rospy.sleep(2)
    controller.lanzame(linear_x=0.5, tiempo=0.5)
    rospy.sleep(2)
    rate = rospy.Rate(10)
                ...
                for box in boxes:
                    ...
                    if conf > 0.80:
                        ...
                        if levantar == 1:
                            ...
                            velocidadY = Ky * dY
                            velocidadZ = Kz * dW
                            velocidadX = np.clip(velocidadX, -0.32, 0.32)
                            ...
                            if all(historialCentro is True for historialCentro in centrar):
                                ...
                                controller.lanzame(linear_x=0.5, tiempo=1.9)
                                rospy.sleep(2)
                                controller.giro(angular_z=direccionGiro[ventanasPasadas][0], tiempoGiro=direccionGiro[ventanasPasadas][1])
                                # 1.8
                                print("Num: ", ventanasPasadas)
                                rospy.sleep(2)
                                if ventanasPasadas == 1:
                                    controller.lanzame(linear_y=-0.65, tiempo=0.5)
                                    rospy.sleep(2)
                                if ventanasPasadas == 2:
                                    controller.lanzame(linear_z=0.7, tiempo=0.5)
                                    rospy.sleep(2)
                                if ventanasPasadas == 3:
                                    controller.lanzame(linear_y=-0.6, tiempo=1.1)
                                    rospy.sleep(2)
                                    controller.lanzame(linear_x=-0.5, tiempo=0.5)
                                    rospy.sleep(2)
                                if ventanasPasadas == 4:
                                    controller.lanzame(linear_y=-0.6, tiempo=0.3)
                                    rospy.sleep(2)
                                    controller.lanzame(linear_z=0.7, tiempo=0.5)
                                    rospy.sleep(2)
                                if ventanasPasadas == 5:
                                    controller.lanzame(linear_y=-0.6, tiempo=0.7)
                                    rospy.sleep(2)
                                    controller.lanzame(linear_x=-0.5, tiempo=0.7)
                                    rospy.sleep(2)
                                if ventanasPasadas == 10:
                                    controller.lanzame(linear_y=-0.6, tiempo=1.35)
                                    rospy.sleep(2)
                                if ventanasPasadas == 11:
                                    controller.lanzame(linear_y=-0.6, tiempo=0.9)
                                    rospy.sleep(2)
                                ventanasPasadas += 1
                                print("Num: ", ventanasPasadas)
